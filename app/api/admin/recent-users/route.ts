...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[admin/recent-users] cookies', { accessCookie, sessionCookie });
    ...
    if (!user) {
      ...
      console.log('[admin/recent-users] requireAdmin result', { hasSession: adminResult.hasSession, userEmail: adminResult.user?.email });
    ...
    if (!user) {
      console.warn('[admin/recent-users] unauthorized after TokenManager + requireAdmin');
